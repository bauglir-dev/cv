...
\quote{
	\\[1cm]
	I am a professional from Universidad Nacional de Colombia with ongoing studies from Universidad de Bogotá Jorge Tadeo Lozano.
	\\[1cm]
	I have been working mainly in financial services companies. I have 3 years of experience with Oracle and SQL Server Databases. Also I have worked woth ETL development tools like Infosphere DataStage and Integration Services. I have programming skills with the languages Python and R. In my free tiem I experiment with Unix-like operating systems, the C programming language and free software.
	\\[1cm]
	I maintain an obssesive learning spirit and I used to promote technical excellence in the final products. I'm very compromised with honesty and ethics in the workplace.}
...
\begin{document}
	...
	{\vspace{0.15cm}
		...
		\vspace{0.3cm}}
	\cvitem{}{
		Entre febrero de 2021 y mayo de 2021 trabajé en la Dirección Data Warehouse cubriendo las necesidades de información de las áreas de producto de la compañía. Cada integrante de la dirección recibía los requerimientos y us responsabilidad era desarrollarlos de principio a fin, desde el análisis y el diseño hasta presentación de los indicadores y las pruebas. Se utilizó principalmente SQL Server 2017 para la base de datos, Integration Services para la ETL y Power BI para la visualización de indicadores.}
	\cvitem{}
	{}
